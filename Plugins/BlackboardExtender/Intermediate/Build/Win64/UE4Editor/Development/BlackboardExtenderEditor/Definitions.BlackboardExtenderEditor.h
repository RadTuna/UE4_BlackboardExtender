#undef BLACKBOARDEXTENDEREDITOR_API
...
#define UE_PROJECT_NAME BlackboardExtension
#define UE_TARGET_NAME BlackboardExtensionEditor
...
#define BLACKBOARDEXTENDER_API DLLIMPORT
#define BLACKBOARDEXTENDEREDITOR_API DLLEXPORT
