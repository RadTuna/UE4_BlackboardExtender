...
#include "BEBehaviorTreeGraphNode.generated.h"

class UEdGraph;
class UEdGraphSchema;

UCLASS()
class UBEBehaviorTreeGraphNode : public UAIGraphNode
{
	GENERATED_UCLASS_BODY()

	/** only some of behavior tree nodes support decorators */
	UPROPERTY()
	TArray<UBEBehaviorTreeGraphNode*> Decorators;

	/** only some of behavior tree nodes support services */
	UPROPERTY()
	TArray<UBEBehaviorTreeGraphNode*> Services;

	//~ Begin UEdGraphNode Interface
	virtual class UBEBehaviorTreeGraph* GetBehaviorTreeGraph();
