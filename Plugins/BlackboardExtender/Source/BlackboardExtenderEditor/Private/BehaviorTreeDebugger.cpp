...
void FBehaviorTreeDebugger::SetNodeFlags(const struct FBehaviorTreeDebuggerInstance& Data, class UBEBehaviorTreeGraphNode* Node, class UBTNode* NodeInstance)
{
...
void FBehaviorTreeDebugger::SetCompositeDecoratorFlags(const struct FBehaviorTreeDebuggerInstance& Data, class UBEBehaviorTreeGraphNode_CompositeDecorator* Node)
{
	const bool bIsShowingCurrentState = IsShowingCurrentState();
...
void FBehaviorTreeDebugger::UpdateAssetFlags(const struct FBehaviorTreeDebuggerInstance& Data, class UBEBehaviorTreeGraphNode* Node, int32 ExecutionStepId)
{
	if (Node == NULL)
	{
		return;
	...
	for (int32 PinIdx = 0; PinIdx < Node->Pins.Num(); PinIdx++)
	{
		...
		{
			UBEBehaviorTreeGraphNode* LinkedNode = Cast<UBEBehaviorTreeGraphNode>(Pin->LinkedTo[i]->GetOwningNode());
			if (LinkedNode)
			{
				...
				{
					UBEBehaviorTreeGraphNode_Decorator* DecoratorNode = Cast<UBEBehaviorTreeGraphNode_Decorator>(LinkedNode->Decorators[iAux]);
					...
					UBEBehaviorTreeGraphNode_CompositeDecorator* CompDecoratorNode = Cast<UBEBehaviorTreeGraphNode_CompositeDecorator>(LinkedNode->Decorators[iAux]);
				...
				{
					UBEBehaviorTreeGraphNode_Service* ServiceNode = Cast<UBEBehaviorTreeGraphNode_Service>(LinkedNode->Services[iAux]);
...
void FBehaviorTreeDebugger::UpdateAssetRuntimeDescription(const TArray<FString>& RuntimeDescriptions, class UBEBehaviorTreeGraphNode* Node)
{
	if (Node == NULL)
	{
		return;
...
void FBehaviorTreeDebugger::SetNodeRuntimeDescription(const TArray<FString>& RuntimeDescriptions, class UBEBehaviorTreeGraphNode* Node, class UBTNode* NodeInstance)
{
...
void FBehaviorTreeDebugger::SetCompositeDecoratorRuntimeDescription(const TArray<FString>& RuntimeDescriptions, class UBEBehaviorTreeGraphNode_CompositeDecorator* Node)
{
...
void FBehaviorTreeDebugger::CollectBreakpointsFromAsset(class UBEBehaviorTreeGraphNode* Node)
{
	if (Node == NULL)
	{
		return;
...
void FBehaviorTreeDebugger::OnBreakpointAdded(class UBEBehaviorTreeGraphNode* Node)
{
	if (IsDebuggerReady())
	{
...
void FBehaviorTreeDebugger::OnBreakpointRemoved(class UBEBehaviorTreeGraphNode* Node)
{
	if (IsDebuggerReady())
	{
		UBTNode* BTNode = Cast<UBTNode>(Node->NodeInstance);
