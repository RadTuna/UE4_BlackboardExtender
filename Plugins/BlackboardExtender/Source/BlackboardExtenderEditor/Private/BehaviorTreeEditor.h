...
class FBehaviorTreeEditor : public IBEBehaviorTreeEditor, public FAIGraphEditor, public FNotifyHook
{
public:
	FBehaviorTreeEditor();
	/** Destructor */
...
private:
	...
	void GetAbortModePreview(const class UBEBehaviorTreeGraphNode_CompositeDecorator* Node, struct FAbortDrawHelper& Mode0, struct FAbortDrawHelper& Mode1);
	...
	TWeakObjectPtr<class UBEBehaviorTreeGraphNode_CompositeDecorator> FocusedGraphOwner;
