...
class FEdGraphSchemaAction_ExtendBlackboardEntry : public FEdGraphSchemaAction_Dummy
{
public:
	static FName StaticGetTypeId();
	virtual FName GetTypeId() const;

	FEdGraphSchemaAction_ExtendBlackboardEntry( UBlackboardData* InBlackboardData, FBlackboardEntry& InKey, bool bInIsInherited );
...
protected:
	...
	TSharedPtr<FEdGraphSchemaAction_ExtendBlackboardEntry> GetSelectedEntryInternal() const;
