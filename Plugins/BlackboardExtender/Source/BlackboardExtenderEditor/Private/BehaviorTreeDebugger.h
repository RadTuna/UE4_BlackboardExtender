...
public:
	...
	void OnBreakpointAdded(UBEBehaviorTreeGraphNode* Node);
	void OnBreakpointRemoved(UBEBehaviorTreeGraphNode* Node);
...
private:
	...
	TWeakObjectPtr<class UBEBehaviorTreeGraphNode_Root> RootNode;
	...
	void CollectBreakpointsFromAsset(class UBEBehaviorTreeGraphNode* Node);

	/** recursively update node flags on all child nodes */
	void UpdateAssetFlags(const struct FBehaviorTreeDebuggerInstance& Data, class UBEBehaviorTreeGraphNode* Node, int32 StepIdx);

	/** set debugger flags on GraphNode */
	void SetNodeFlags(const struct FBehaviorTreeDebuggerInstance& Data, class UBEBehaviorTreeGraphNode* Node, class UBTNode* NodeInstance);

	/** set debugger flags on GraphNode for composite decorator */
	void SetCompositeDecoratorFlags(const struct FBehaviorTreeDebuggerInstance& Data, class UBEBehaviorTreeGraphNode_CompositeDecorator* Node);

	/** recursively update node flags on all child nodes */
	void UpdateAssetRuntimeDescription(const TArray<FString>& RuntimeDescriptions, class UBEBehaviorTreeGraphNode* Node);

	/** set debugger flags on GraphNode */
	void SetNodeRuntimeDescription(const TArray<FString>& RuntimeDescriptions, class UBEBehaviorTreeGraphNode* Node, class UBTNode* NodeInstance);

	/** set debugger flags on GraphNode for composite decorator */
	void SetCompositeDecoratorRuntimeDescription(const TArray<FString>& RuntimeDescriptions, class UBEBehaviorTreeGraphNode_CompositeDecorator* Node);
